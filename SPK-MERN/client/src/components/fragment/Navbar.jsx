            ...
            <nav className="flex-grow">
                <ul className="space-y-2 p-4">
                    <li>
                        <Link
                            to="/home"
                            className={`p-2 rounded block ${isActive('/home') ? 'bg-green-500' : 'hover:bg-green-500'}`}
                        >
                            Data Relawan
                        </Link>
                    </li>
                    <li>
                        <Link
                            to="/kriteria"
                            className={`p-2 rounded block ${isActive('/kriteria') ? 'bg-green-500' : 'hover:bg-green-500'}`}
                        >
                            Kriteria
                        </Link>
                    </li>
                    <li>
                        <Link
                            to="/penilaian"
                            className={`p-2 rounded block ${isActive('/penilaian') ? 'bg-green-500' : 'hover:bg-green-500'}`}
                        >
                            Penilaian
                        </Link>
                    </li>
                    <li>
                        <Link
                            to="/rangking"
                            className={`p-2 rounded block ${isActive('/rangking') ? 'bg-green-500' : 'hover:bg-green-500'}`}
                        >
                            Hasil
                        </Link>
                    </li>
